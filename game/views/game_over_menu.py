...
class Main(arcade.View):
    ...
    def __init__(self, config):
        ...
        title_texture = self.conf.assets.texture('game_over_title')
        ...
        self.start_button.on_click = self.continue_button_click
    ...
    def on_mouse_motion(self, x: int, y: int, dx: int, dy: int):
        self.mouse.position = self.camera.unproject((x, y))
